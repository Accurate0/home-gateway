...
#define EPD_IMAGE_DATA_BUFFER                                                  \
  8192 // MCU RAM Size (800*720/2) reserve for one driver IC
...
__GDEP133C02_EXTERN__ void setPinCs(unsigned char csNumber,
...
__GDEP133C02_EXTERN__ void writeEpd(unsigned char epdCommand,
                                    unsigned char *epdData,
                                    unsigned int epdDataLength);
__GDEP133C02_EXTERN__ void readEpd(unsigned char epdCommand,
                                   unsigned char *epdData,
                                   unsigned int epdDataLength);
__GDEP133C02_EXTERN__ void writeEpdCommand(unsigned char epdCommand);
__GDEP133C02_EXTERN__ void writeEpdData(unsigned char *epdData,
                                        unsigned int epdDataLength);
__GDEP133C02_EXTERN__ void epdDisplay(void);
__GDEP133C02_EXTERN__ void epdDisplayColor(unsigned char colorSelect);
__GDEP133C02_EXTERN__ void writeEpdImage(unsigned char csx,
...
__GDEP133C02_EXTERN__ char partialWindowUpdateWithImageData(
    unsigned char csx, unsigned char const *imageData, unsigned long dataSize,
    unsigned int xStart, unsigned int yStart, unsigned int xPixel,
    unsigned int yLine, unsigned char displayEnable);
__GDEP133C02_EXTERN__ char partialWindowUpdateWithoutImageData(
