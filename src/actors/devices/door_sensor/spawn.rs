use super::{DoorSensorHandler, DoorSensorHandlerBuilder, Message};
...
pub async fn spawn_door_handler(
    ...
    let door_handler_factory_args = FactoryArguments::builder()
        .worker_builder(Box::new(DoorSensorHandlerBuilder { shared_actor_state }))
    ...
    let (_, _) = root_supervisor_ref
        .spawn_linked(
            Some(DoorSensorHandler::NAME.to_string()),
