...
scopes! {
    ...
    EventsCustom => "events.custom" [Read],
    EventsDeviceConnection => "events.device_connection" [Read],
...
impl Resource {
    pub fn for_event_kind(kind: &str) -> Option<Self> {
        Some(match kind {
            ...
            "device_connection" => Self::EventsDeviceConnection,
