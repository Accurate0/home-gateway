// Copied from the unstable `ip` feature (rust-lang/rust#27709) in core, pending stabilisation:
// https://doc.rust-lang.org/src/core/net/ip_addr.rs.html#887
...
pub const fn is_global_v6(ip: Ipv6Addr) -> bool {
    !(ip.is_unspecified()
        || ip.is_loopback()
